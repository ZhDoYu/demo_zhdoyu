...
public class Product {
    ...
    public int getSaleCountFore() {
        return saleCountFore;
    }
    public void setSaleCountFore(int saleCountFore) {
        this.saleCountFore = saleCountFore;
    }
